defmodule Stytch.SSO do
  ...
  @spec complete(body :: map, opts :: keyword) ::
          {:ok, Stytch.SSO.complete_200_json_resp()} | {:error, Stytch.Error.t()}
  def complete(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [
        {200, {Stytch.SSO, :complete_200_json_resp}},
  ...
  @spec create_external_connection(organization_id :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Stytch.SSO.create_external_connection_200_json_resp()}
  ...
  def create_external_connection(organization_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      request: [{"application/json", :map}],
      response: [
        {200, {Stytch.SSO, :create_external_connection_200_json_resp}},
        default: {Stytch.ErrorResponse, :t}
      ],
      opts: opts
    })
  ...
  @spec create_oidc(organization_id :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Stytch.SSO.create_oidc_200_json_resp()} | {:error, Stytch.Error.t()}
  def create_oidc(organization_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      request: [{"application/json", :map}],
      response: [
        {200, {Stytch.SSO, :create_oidc_200_json_resp}},
        default: {Stytch.ErrorResponse, :t}
      ],
      opts: opts
    })
  ...
  @spec create_saml(organization_id :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Stytch.SSO.create_saml_200_json_resp()} | {:error, Stytch.Error.t()}
  def create_saml(organization_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      request: [{"application/json", :map}],
      response: [
        {200, {Stytch.SSO, :create_saml_200_json_resp}},
        default: {Stytch.ErrorResponse, :t}
      ],
      opts: opts
    })
  ...
  @spec delete_connection(
          ...
          connection_id :: String.t(),
          opts :: keyword
        ) :: {:ok, Stytch.SSO.delete_connection_200_json_resp()} | {:error, Stytch.Error.t()}
  def delete_connection(organization_id, connection_id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :delete,
      response: [
        {200, {Stytch.SSO, :delete_connection_200_json_resp}},
        default: {Stytch.ErrorResponse, :t}
      ],
      opts: opts
    })
  ...
  @spec delete_saml_verification_certificate(
          ...
          {:ok, Stytch.SSO.delete_saml_verification_certificate_200_json_resp()}
          | {:error, Stytch.Error.t()}
  def delete_saml_verification_certificate(
    ...
    client.request(%{
      ...
      method: :delete,
      response: [
        {200, {Stytch.SSO, :delete_saml_verification_certificate_200_json_resp}},
        default: {Stytch.ErrorResponse, :t}
      ],
      opts: opts
    })
  ...
  @spec get_connections(organization_id :: String.t(), opts :: keyword) ::
          {:ok, Stytch.SSO.get_connections_200_json_resp()} | {:error, Stytch.Error.t()}
  def get_connections(organization_id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {Stytch.SSO, :get_connections_200_json_resp}},
        default: {Stytch.ErrorResponse, :t}
      ],
      opts: opts
    })
  ...
  @spec get_oidc_access_token(
          ...
          member_id :: String.t(),
          opts :: keyword
        ) :: {:ok, Stytch.SSO.get_oidc_access_token_200_json_resp()} | {:error, Stytch.Error.t()}
  def get_oidc_access_token(organization_id, member_id, opts \\ []) do
    ...
    client.request(%{
      ...
      query: query,
      response: [
        {200, {Stytch.SSO, :get_oidc_access_token_200_json_resp}},
        default: {Stytch.ErrorResponse, :t}
      ],
      opts: opts
    })
  ...
  """
  @spec start(opts :: keyword) ::
          {:ok, Stytch.SSO.start_200_json_resp()} | {:error, Stytch.Error.t()}
  def start(opts \\ []) do
    client = opts[:client] || @default_client
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {Stytch.SSO, :start_200_json_resp}}, default: {Stytch.ErrorResponse, :t}],
      opts: opts
    })
  end
  ...
  @spec update_external_connection(
          ...
          {:ok, Stytch.SSO.update_external_connection_200_json_resp()}
          | {:error, Stytch.Error.t()}
  def update_external_connection(organization_id, connection_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      request: [{"application/json", :map}],
      response: [
        {200, {Stytch.SSO, :update_external_connection_200_json_resp}},
        default: {Stytch.ErrorResponse, :t}
      ],
      opts: opts
    })
  ...
  @spec update_oidc(
          ...
          body :: map,
          opts :: keyword
        ) :: {:ok, Stytch.SSO.update_oidc_200_json_resp()} | {:error, Stytch.Error.t()}
  def update_oidc(organization_id, connection_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      request: [{"application/json", :map}],
      response: [
        {200, {Stytch.SSO, :update_oidc_200_json_resp}},
        default: {Stytch.ErrorResponse, :t}
      ],
      opts: opts
    })
  ...
  @spec update_saml(
          ...
          body :: map,
          opts :: keyword
        ) :: {:ok, Stytch.SSO.update_saml_200_json_resp()} | {:error, Stytch.Error.t()}
  def update_saml(organization_id, connection_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      request: [{"application/json", :map}],
      response: [
        {200, {Stytch.SSO, :update_saml_200_json_resp}},
        default: {Stytch.ErrorResponse, :t}
      ],
      opts: opts
    })
  ...
  @spec update_saml_by_metadata_url(
          ...
          {:ok, Stytch.SSO.update_saml_by_metadata_url_200_json_resp()}
          | {:error, Stytch.Error.t()}
  def update_saml_by_metadata_url(organization_id, connection_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      request: [{"application/json", :map}],
      response: [
        {200, {Stytch.SSO, :update_saml_by_metadata_url_200_json_resp}},
        default: {Stytch.ErrorResponse, :t}
      ],
      opts: opts
    })
